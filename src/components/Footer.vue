  ...
  <div class="footer">
    <div class="footer__container">
      ...
      <div class="footer__links">
        <a class="footer-link" href="#"><h5>ABOUT</h5></a>
        <a class="footer-link" href="#"><h5>WORKS</h5></a>
        <a class="footer-link" href="#"><h5>CONTACTS</h5></a>
        <a class="footer-link" href="#"><h5>CAREERS</h5></a>
      </div>
      <div class="footer__copyright">©2018 All right reserved.</div>
    </div>
  </div>
</template>
